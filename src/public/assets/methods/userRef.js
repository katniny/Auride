// weakmap to track active listeners for each UserRef instance
const activeUserRefListeners = new WeakMap();
...
class UserRef {
    ...
    constructor(auride, query = {}) {
        ...
        activeUserRefListeners.set(this, []);
    }

    /**
     * Filter the query by user ID (UID)
     * Returns a new UserRef instance with updated query
     ...
     */
    byUsername(username) {
        return new UserRef(this.auride, { ...this.query, username, reqType: "username" });
    }
