import{t as e}from"./index-BjBKTcKe.js";async function t(e){try{let t=await(await fetch(`/updates.jsonc`)).json();return t[e]==null?!1:t[e]}catch(e){return e}}function n(e){let t=document.createElement(`h3`);return t.textContent=`There are no any ${e||`...unknown update version...`} versions yet. We're working to get there!`,t.className=`noUpdatesAvailableText`,t}async function r(){document.title=`Updates | Auride`;let r=document.createElement(`div`);r.innerHTML=`
