import{a as e,l as t}from"./router-fU7goLPj.js";import{t as n}from"./checkFileType-BmvIHc4A.js";import{o as r}from"./index-BBeCNjCH.js";async function i(i){if(!i)throw Error(`No profile picture given.`);let o=await n(i);if(!o||o!==`img`)throw Error(`Auride only accepts images as profile pictures!`);let s=document.createElement(`dialog`);s.innerHTML=`
