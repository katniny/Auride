import{i as e,l as t,n}from"./router-fU7goLPj.js";import{l as r}from"./index-BBeCNjCH.js";async function i(){let i=await e();(!i?.suspended||i?.suspended?.suspended)&&n(`/`);let a=document.createElement(`div`);return a.innerHTML=`
