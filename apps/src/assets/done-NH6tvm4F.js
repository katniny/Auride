import{i as e,l as t,n}from"./router-fU7goLPj.js";async function r(){if(!await e()){n(`/auth/register`);return}document.title=`Thanks for signing up! | Auride`;let r=document.createElement(`div`);return r.innerHTML=`
        <div class="authForm">
            <div class="info">
