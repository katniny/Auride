import"./versioning-CME6rGrq.js";function e(){document.title=`Roadmap | Auride`;let e=document.createElement(`div`);return e.innerHTML=`
        ...
        <li class="success">Alpha (DONE!)</li>
            <li class="indented">Auride will be less buggy and more "feature-complete", but may contain bugs and missing features.</li>
        ...
        <li class="caution">Pre-Release (Target: Late 2026 to early 2027)</li>
            <li class="indented">Auride is nearly ready for release but is undergoing final polish and bug fixing.</li>
        <li class="caution">Release (Target: Mid-to-Late 2027)</li>
            <li class="indented">
