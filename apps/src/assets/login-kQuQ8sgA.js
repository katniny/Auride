import{l as e,n as t,o as n}from"./router-CC3EAHV2.js";import{r}from"./index-BjBKTcKe.js";import{t as i}from"./resetPassword-CzDxG-mL.js";async function a(e,r){if(!e||!r)throw Error(`You're missing the email or password to login.`);try{await n.signInWithEmailAndPassword(e,r),t(`/home`),window.location.reload()}catch(e){let t=e.message.replace(/^Firebase:\s*/,``);throw Error(t)}}async function o(){document.title=`Login | Auride`;let n=document.createElement(`div`);if(n.innerHTML=`
        <div class="authForm">
            <div class="info">
